...
//         <div className='restaurant_select'>
//             <div className='restaurant_select_top'>
//                 <div onClick={this.displayList} className='restaurant_select_top-header font-effect-outline'>{title ? title : "Выбери ресторан"}</div>
//                 <div className='arrow_picker'>
//                     <div className='arrow_picker-up'></div>
//                     <div className='arrow_picker-down'></div>
//                 </div>
...
//             {display ? <div className='restaurant_select_button'>
//                 <ul>
//                 {restaurants.map(restaurant => {
...
//             {title && !display ? <button onClick={this.ToRestaurant}>Перейти в ресторан</button> : null}
//         </div>
//     );
// };
